...
{
    class AnalyticsReceiptViewModel : ViewModelBase
    {
        APIService ObjAnalyticsService;
        private string _Path;

        public AnalyticsReceiptViewModel()
        {
            ...
            InputSales = new AnalyticsReceipt();
            ...
            SelectedStatus = "All";
            SelectedSales = new AnalyticsReceipt();
        ...
        //Filter section
        private AnalyticsReceipt inputSales;
        public AnalyticsReceipt InputSales
        {
        ...
        //Main section
        private ObservableCollection<AnalyticsReceipt> salesList;
        public ObservableCollection<AnalyticsReceipt> SalesList
        {
            get { return salesList; }
            set { salesList = value; OnPropertyChanged("SalesList"); }
        }

        private AnalyticsReceipt selectedSales;
        public AnalyticsReceipt SelectedSales
        {
        ...
        private async Task Search()
        {
            ...
            try
            {
                ...
                RootAnalyticsReceiptObject Response = await ObjAnalyticsService.PostAPI("getSalesList", param, _Path);
                ...
                //datagrid
                SalesList = new ObservableCollection<AnalyticsReceipt>(Response.Data);
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (msgBoxResult == MessageBoxResult.Yes)
                    {
                        ...
                        RootAnalyticsReceiptObject Response = await ObjAnalyticsService.PostAPI("voidSales", param, _Path);
        ...
        private async Task PrintReport()
        {
            try
            {
                ...
                RootAnalyticsReceiptObject Response = await ObjAnalyticsService.PostAPI("getSalesSummary", param, _Path);
